...
public class EgindakoEskaintzakActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    public static SectionsPagerAdapter mSectionsPagerAdapter;
    public static ViewPager mViewPager;

    public static ArrayList<Eskaintza> eskaintza_guztiak=new ArrayList<>();private static boolean kargatua=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            public void run() {
                eskaintza_guztiak= Merkatua.EgindakoEskaintzak();kargatua=true;
            }
        }).start();
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    final ArrayList<Eskaintza> eskaintza_tramitatuak=Merkatua.EgindakoEskaintzakTramitatuak(eskaintza_guztiak);
                    final ArrayList<Eskaintza> eskaintza_tramitatu_gabeak=Merkatua.EgindakoEskaintzakTramitatuGabeak(eskaintza_guztiak);
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            (rootView.findViewById(R.id.loading)).setVisibility(View.GONE);
                            if(index==0){
                                AdapterJokalariaEskaintzakEginak adapter = new AdapterJokalariaEskaintzakEginak(getActivity(), eskaintza_tramitatu_gabeak);
                                lv.setAdapter(adapter);
                            }else{
                                AdapterJokalariaEskaintzakEginak adapter = new AdapterJokalariaEskaintzakEginak(getActivity(), eskaintza_tramitatuak);
                                lv.setAdapter(adapter);
                            }
                        }
                    });
    ...
    class CallWebService extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            eskaintza_guztiak= Merkatua.EgindakoEskaintzak();
            return "";
        }
    }
